...
export const CourseMain = () => {
  ...
  const assets = [
    ...
    { text: "Style guide for fonts, colors, etc", icon: <BsCheckLg />, id: 2 },
    { text: "Optimized image assets", icon: <BsCheckLg />, id: 3 },
    { text: "README file to help you get started", icon: <BsCheckLg />, id: 4 },
    { text: "HTML file with pre-written content", icon: <BsCheckLg />, id: 5 }
  ];
    ...
    <div className="course-main-wrap">
      <div className="course-main-flex">
        <div className="course-main-left">
          {state.image ? (
            <div className="course-left-wrap">
              <img alt="" className="course-left-img" src={state.image}></img>
            </div>
          ) : null}
        ...
        <div className="course-main-right">
          ...
          <div>
            <div className="home-card-down-header">{state.header}</div>
            <div className="home-card-down-text">{state.text}</div>
          </div>
          <div className="course-right-box">
            <div>
              <div className="course-right-header">{"Assets Provided"}</div>
